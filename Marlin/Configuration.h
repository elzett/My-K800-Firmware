...
#define DELTA_DIAGONAL_ROD 210.0 //210.0 //186.0 // mm

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 0.0 //150.0 //128.0 // mm

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 0.0 //32.5 //19.9 // mm

// Horizontal offset of the universal joints on the carriages.
#define DELTA_CARRIAGE_OFFSET 0.0 //22.0 //19.5 // mm

// Horizontal distance bridged by diagonal push rods when effector is centered.
#define DELTA_RADIUS 108.0 //(DELTA_SMOOTH_ROD_OFFSET-DELTA_EFFECTOR_OFFSET-DELTA_CARRIAGE_OFFSET)

// Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
#define DELTA_PRINTABLE_RADIUS 70.0

// Effective X/Y positions of the three vertical towers.
#define SIN_58 0.84804809615
#define COS_58 0.52991926423
...
#define DELTA_TOWER1_X -SIN_60*(DELTA_RADIUS * 1.0) // front left tower
#define DELTA_TOWER1_Y -COS_60*(DELTA_RADIUS * 1.0)
#define DELTA_TOWER2_X SIN_60*(DELTA_RADIUS * 1.0) // front right tower
#define DELTA_TOWER2_Y -COS_60*(DELTA_RADIUS * 1.0)
#define DELTA_TOWER3_X 0.0 // back middle tower
#define DELTA_TOWER3_Y (DELTA_RADIUS * 1.0)
...
// Ultimaker
    #define  DEFAULT_Kp 51.68 //22.2
    #define  DEFAULT_Ki 4.90 //1.08
    #define  DEFAULT_Kd 136.32 //114
...
#define ENABLE_AUTO_BED_LEVELING // Delete the comment to enable (remove // at the start of the line)
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER 13.2
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 17.8
...
#define MANUAL_Z_HOME_POS 315.4  // For delta: Distance between nozzle and print surface after homing.
